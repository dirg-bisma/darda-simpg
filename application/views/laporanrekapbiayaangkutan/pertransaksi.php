...
<table style="width:100%;font-size:10px" >
	...
	<tr>
		<td style="font-size:15px;text-align:center;"><b>PER TRANSAKSI<br /><?php echo CNF_PG;?> / <?php echo $kat;?></b></td>
	</tr>
	<tr>
...
$par = $detail[$key-1]->id_angkutan;
if ($par != $val->id_angkutan ) {
	
?>
<table class="tableizer-table">
	<thead>
		<tr>
			<td colspan="2" style="text-align: center; background:red;color:#FFF;"><?php echo $val->kode_tx;?> - <?php echo $val->tgl;?></td>
			<td colspan="8"></td>
		</tr>
		<tr>
			<th>No</th>
	...
	<tbody>
		...
		$ttl = 0;
		$tnetto = 0;
			$par1 = $detail[$key]->id_angkutan;
			foreach ($detail as $a) {
				if ($a->id_angkutan == $par1) {
		?>
		<tr>
