          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box box-danger">
                  ...
                  <h3 class="box-title">Laporan Harian Timbangan V.2</h3>
...
$(document).ready(function(){
        ...
        $("#kat").jCombo("<?php echo site_url('mmasterfield/comboselect?filter=sap_m_kat_lahan:nama_kat_lahan:nama_kat_lahan') ?>",
		{  selected_value : '', initial_text :'- SEMUA KAT -' });
		autocompleted();
...
function getReport(){
	$.ajax({
	 	type 	: "POST",
	 	datatype: "json",
	 	url 	: "<?php echo site_url('laporantimbangan/printlaporanvdua'); ?>",
...
var urlx = out.join('&');
	...
	var url = "<?php echo site_url('laporantimbangan/printlaporanvdua'); ?>?"+urlx+"&excel=1";
	window.open(url);
